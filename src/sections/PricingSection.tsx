...
export default function PricingSection() {
    return (
        <div id="pricing" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Pricing" text2="Simple Pricing for Every Creator" text3="Choose a plan that fits your content goals — from beginners to full-time creators." />
