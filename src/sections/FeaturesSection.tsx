...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why Thumblify" text3="Everything you need to turn ideas into thumbnails people actually want to click." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                   Thumblify helps creators turn ideas into thumbnails that get clicked — without design skills or wasted time.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Thumbnails That Drive More Views</h3>
                        <p className="text-slate-300 mt-2">Create eye-catching thumbnails optimized for attention, clicks, and engagement — powered by AI that understands what works.</p>
